...
namespace VendorTracker.Tests
{
  ...
  public class OrderTests : IDisposable 
  {
    ...
    {
      //Arrange
      string name1 = "Vendor for Italian restaurant";
      string name2 = "Pastini";
      string description1 = "Sells breadsticks";
      string description2 = "Italian restaurant";
      Order newOrder1 = new Order(name1, description1, "test", "test");
      Order newOrder2 = new Order(name2, description2, "test", "test");
